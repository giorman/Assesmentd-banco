function fn() {
  ...
  const config = {
    ...
    oasUrl: 'co/com/unit/user-central-management_1.0.0.yaml',
    urlBase: 'https://api.us-east-a.apiconnect.ibmappdomain.cloud/apiconect/sandbox/v1/service/user-central-management'
  };
