function fn() {
  ...
  const config = {
    ...
    oasUrl: 'co/com/unit/client-central-information_1.0.0.yaml',
    oasUrl2: 'co/com/unit/client-central-management_1.0.0.yaml',
    urlBase: 'https://api.us-east-a.apiconnect.ibmappdomain.cloud/apiconect/sandbox/v1/service'
  };
